...
const Icons = {
  ...
  Table: () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"></rect><path d="M3 9h18M3 15h18M9 3v18M15 3v18"></path></svg>,
    ...
    >
      ...
      {!isDragging && showAddInMenu && (
        <div className="glass-extreme" style={{
          ...
          <ToolbarButton toolId="table" icon={Icons.Table} label="Tabela" isActive={activeTool === 'table'} onClick={() => { setActiveTool('table'); setShowAddInMenu(false); }} />
